/// \ project: RayTracing
/// \ file: Camera.cpp
/// \ author: Thomas Clermont (by Yan Chernikov)
...
bool Camera::OnUpdate(float ts)
{
	...
	if (!Input::IsMouseButtonPress(GLFW_MOUSE_BUTTON_2))
	{
...
{
	m_Projection = glm::perspectiveFov(glm::radians(m_FOV), (float)m_ViewportWidth,
